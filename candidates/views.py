    ...
    if request.method == 'POST':
        ...
        if p1 == p2:
            if auth.authenticate(request, username=uname, password=p1) is not None:
                ...
                return render(request, 'candidates_admin/delete.html',{'error': 'WRONG USERNAME/PASSWORD', 'candidates':candidates})
        else:
            return render(request, 'candidates_admin/delete.html',
